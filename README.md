...
Online mode sends rendered PDF pages and required close-up areas to Anthropic. Offline mode sends rendered pages to the DeepSeek-OCR endpoint entered by the user. PDF rendering, review, storage, Excel generation, JPG generation, and PDF chart generation occur locally.
