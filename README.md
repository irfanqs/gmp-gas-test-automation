...
The application sends rendered PDF pages and a cropped date area to Anthropic. PDF rendering, review, storage, Excel generation, JPG generation, and PDF chart generation occur locally.
